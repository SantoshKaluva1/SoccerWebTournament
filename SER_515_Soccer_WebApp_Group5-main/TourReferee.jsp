...
<h2 style="width:400px !important; margin-left:38% !important;" id="sponserHeader"> Referee's of the tournament </h2>
<table id="teams">
...
if(count==0)
{
    %>
    <tr>
      <td> Good things take time, we are still waiting for referee's </td>
  </tr>
  <%
}
%>
