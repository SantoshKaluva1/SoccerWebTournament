...
<% 
    ...
    <div class="login bid">
    <h1>Bid for Sponsership</h1>
    <form action="jsp/saveBids.jsp" method="post"> 
        <p>Sponser</p>
        <input type="text" name="sname" placeholder="Enter Sponser's Brand/Name" required>
        <p>Email Id</p>
        <input type="text" name="smail" placeholder="Enter Sponser's Email" required> 
        <p>Sponser Goods/Amount</p>
        <textarea rows="5" cols="30" name="stype" placeholder="Specify the of sponsered goods/Amount in detail" required></textarea>
        <input class="sponserSubmit" type="submit" name="submit" value="Submit Bid">
    </form>
  </div>
  </body>
</head>
