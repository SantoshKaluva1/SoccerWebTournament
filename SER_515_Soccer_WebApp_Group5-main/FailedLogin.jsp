...
<div class="logo">
         ...
         <a href="rules.html">Game Rules</a>
            ...
            <a class="active" href="login.html"><i class="fa fa-sign-in" aria-hidden="true"></i> Log In</a>
          </div>
    ...
    width: 500px;
    margin-left:33%;
    padding-left: 10px;"> Invalid username: <%= session.getAttribute("username") %> or password, please try again </h3>

    <div class="login">
        <img src="css/icon.png" class="icon">
    <h1>Login</h1>
    <form action="jsp/loginValidate.jsp" method="post"> 
        <p>Username</p>
